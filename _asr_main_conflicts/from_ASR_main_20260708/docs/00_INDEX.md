...
- **Huấn luyện thật trên DGX** — vào [`07_dgx_training/`](07_dgx_training/00_README.md): kế hoạch kéo corpus
  (`tools/pull_datasets`) + thang curriculum easy→hard + nhóm model. Điểm vào khi lab có GPU.
